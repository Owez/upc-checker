...
#[test]
fn overflow_upc_a() {
    let my_upc = upc_checker::UPCStandard::UPCA([9,9,9,9,9,12,9,9,9,9,9,9]); // `12` should error
...
#[test]
fn overflow_upc_e() {
    let my_upc = upc_checker::UPCStandard::UPCE([9,9,9,9,9,12,9,9]); // `12` should error
    let my_check_code: i8 = 7;
